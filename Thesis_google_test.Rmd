...
```{r, fig.cap = "Mean transformed $\\triangle$P scores derived from participant’s frequency estimates (with standard error) as a function of $\\triangle$P (0 vs. .467) and outcome density. Reprinted from Crump et al. (2007)", out.width="3in", fig.align = "center"}
